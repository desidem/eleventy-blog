...
function thirdLoop() {
    anim.playSegments([165,225], true);
...
function fourthLoop() {
    anim.playSegments([288,343], true);
...
function fifthLoop() {
    anim.playSegments([405,458], true);
...
function sixthLoop() {
    anim.playSegments([660,752], true);
