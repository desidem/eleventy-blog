...
function firstLoop() {
    anim.playSegments([2276,2277], true);
    animcontainer.addEventListener('click', secondLoop);
                         
};

function secondLoop() {
    anim.playSegments([2663,2995], true);
...
function thirdLoop() {
    anim.playSegments([3391,3645], true);
...
function fourthLoop() {
    anim.playSegments([3812,4156], true);
    anim.addEventListener('complete', removeClick);
