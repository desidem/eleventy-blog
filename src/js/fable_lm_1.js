...
function firstLoop() {
    anim.playSegments([9,11], true);
    animcontainer.addEventListener('click', secondLoop);
                         
};

function secondLoop() {
    anim.playSegments([87,195], true);
...
function thirdLoop() {
    anim.playSegments([233,339], true);
...
function fourthLoop() {
    anim.playSegments([522,629], true);
...
function fifthLoop() {
    anim.playSegments([708,814], true);
...
function sixthLoop() {
    anim.playSegments([925,1031], true);
...
function seventhLoop() {
    anim.playSegments([1085,1115], true);
    anim.addEventListener('complete', removeClick);
