...
var animData = {
	...
	loop: false,
	autoplay: true,
	path: 'fables2/js/data_lm_200.json' 
    /** 
...
function thirdLoop() {
    anim.playSegments([235,341], true);
...
function fourthLoop() {
    anim.playSegments([398,506], true);
...
function fifthLoop() {
    anim.playSegments([522,628], true);
...
function sixthLoop() {
    anim.playSegments([640,670], true);
    anim.addEventListener('complete', removeClick);
