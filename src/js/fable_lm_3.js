...
var animData = {
	...
	loop: false,
	autoplay: true,
	path: 'fables2/js/data_lm_301.json' 
    /** 
...
function secondLoop() {
    anim.playSegments([104,192], true);
...
function thirdLoop() {
    anim.playSegments([290,397], true);
...
function fourthLoop() {
    anim.playSegments([490,595], true);
...
function fifthLoop() {
    anim.playSegments([640,745], true);
...
function sixthLoop() {
    anim.playSegments([780,822], true);
    anim.addEventListener('complete', removeClick);
