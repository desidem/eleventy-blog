...
function firstLoop() {
    anim.playSegments([504,505], true);
    animcontainer.addEventListener('click', secondLoop);
                         
};

function secondLoop() {
    anim.playSegments([1278,1434], true);
...
function thirdLoop() {
    anim.playSegments([1580,1761], true);
...
function fourthLoop() {
    anim.playSegments([1880,2228], true);
