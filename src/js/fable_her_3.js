...
var animData = {
	...
	loop: false,
	autoplay: true,
	path: 'fables/js/heron data 300.json' 
    /** 
...
function thirdLoop() {
    anim.playSegments([341,452], true);
...
function fourthLoop() {
    anim.playSegments([470,651], true);
...
function fifthLoop() {
    anim.playSegments([690,785], true);
    anim.addEventListener('complete', removeClick);
