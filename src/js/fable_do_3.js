...
var animData = {
	...
	loop: false,
	autoplay: true,
	path: 'fables/js/data_do300.json' 
    /** 
...
function firstLoop() {
    anim.playSegments([848,849], true);
    animcontainer.addEventListener('click', secondLoop);
                         
};

function secondLoop() {
    anim.playSegments([900,1045], true);
...
function thirdLoop() {
    anim.playSegments([1075,1219], true);
...
function fourthLoop() {
    anim.playSegments([1261,1417], true);
...
function fifthLoop() {
    anim.playSegments([1449,1560], true);
	anim.addEventListener('complete', removeClick);
